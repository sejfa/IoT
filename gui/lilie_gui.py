...
from crud.crud_db import plant_hum, plant_temp, plant_bright, plant_sal, plant_ph, get_lilie


class LiliePage(tk.Frame):
    ...
    def create_widgets(self):
        self.header = create_label(self, "Lilie care", 350, 35)
        self.pic_frame = ttk.Frame(self)
        self.pic_frame_image = get_image('lilie.jpg', self.pic_frame)
        ...
        self.l= get_lilie()
        self.info = info_label(self, self.l, 2, 120)
