...
from gui import kitchen_basil_gui, hosta_gui, main_menu, recordofplant, recordofpots, signin_gui, plant_list, pot_list
...
class Application(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        windows = [LoginMenu, signin_gui.SigninMenu, main_menu.SecondPage, kitchen_basil_gui.KitchenBasilPage, hosta_gui.HostaPage, recordofpots.RecordOfPots, plant_list.PlantList, pot_list.PotList, recordofplant.RecordOfPlants]
